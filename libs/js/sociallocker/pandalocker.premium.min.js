/*!
 * Panda Lockers - v2.1.2, 2017-03-06 
...
!function(a){var b=a.pandalocker;b.lse||(b.lse={}),b.lse.cldy=b.lse.cldy||function(){var c=document.domain;return"cyrillic"==b.tools.cdmt(c)&&(c=punycode.toASCII(b.tools.ncdn(c))),b.lse.allowDomains&&a.isArray(b.lse.allowDomains)?a.inArray(b.tools.gdms(c),b.lse.allowDomains)>-1:!1},b.lse.gmst=b.lse.gmst||function(){return!1},b.lse.cllk=b.lse.cllk||function(a){return"optinpanda"===a?b.tools.sde(""):b.tools.sde("")}}(__$onp);
...
!function(a){"use strict";a.pandalocker.vk_share||(a.pandalocker.vk_share={});var b=a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);b.name="vk-share",b.sdk="onp",b.verification.container=".onp-button-loaded",b._defaults={pageUrl:null,pageTitle:null,pageDescription:null,pageImage:null,counter:1},b._extractUrl=function(){var b=this.options.pageUrl||this.networkOptions.url||window.location.href;if("cyrillic"==a.pandalocker.tools.cdmt(b)){var c=b.split("/");b=c[0]+"//"+punycode.toASCII(a.pandalocker.tools.ncdn(c[2]))}return a.pandalocker.tools.URL.normalize(b)},b.prepareOptions=function(){this.url=this._extractUrl(),this.alternateURL=this.url,this.options.counter="vertical"===this.groupOptions.layout?!0:this.groupOptions.counters,this.layout=this.groupOptions.layout,"punycode"==a.pandalocker.tools.cdmt(this.url)&&(this.options.counter="vertical"===this.groupOptions.layout?!0:!1)},b.setupEvents=function(){},b._extendCallback=function(b){var c=this;if("shared"===b.event){var d=b.url,e=c.url;if(a.pandalocker.tools.cdmt(d)!=a.pandalocker.tools.cdmt(e)&&"punycode"==a.pandalocker.tools.cdmt(e)&&"cyrillic"==a.pandalocker.tools.cdmt(d)&&(d=punycode.toASCII(a.pandalocker.tools.ncdn(d)),e=a.pandalocker.tools.npcd(e)),a.pandalocker.tools.URL.normalize(d)!==e)return this.showScreen("default"),void this.showNotice(a.pandalocker.lang.alerts.social_share_aborted);this.unlock("button",this.name,this.url)}"notshared"===b.event&&(this.showScreen("default"),this.showNotice(a.pandalocker.lang.alerts.social_share_aborted)),"clickja"===b.event&&this.stepTwoPrompt()},b.renderButton=function(b){var c=this;this.button=a("<div></div>").appendTo(b),this.widgetId="onp-vk-share-widget-"+Math.floor(999999*Math.random()+1),this.button.attr("id",this.widgetId),window.ONPWGT&&window.ONPWGT.init(this.widgetId,"vk-share",{lang:this.groupOptions.lang,pageTitle:this.options.pageTitle,pageDescription:this.options.pageDescription,pageUrl:this.url,alternateURL:this.alternateURL,pageImage:this.options.pageImage,layout:this.layout,counter:this.options.counter,clickja:this.options.clickja},function(a){c._callback(a)})},a.pandalocker.controls["social-buttons"]["vk-share"]=b}(__$onp);
...
!function(a){"use strict";a.pandalocker.data||(a.pandalocker.data={}),a.pandalocker.data.__fbLikeButton=null,a.pandalocker.data.__fbButtonReadyRegister={};var b=a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);b.name="facebook-like",b._defaults={url:null,tooltipText:a.pandalocker.lang.errors.facebookLikeAlertText,layout:"button_count",width:null,verbToDisplay:"like",colorScheme:"light",font:"tahoma",ref:null},b.prepareOptions=function(){this.url=this._extractUrl(),"vertical"===this.groupOptions.layout?this.options.layout="box_count":this.groupOptions.counters||(this.options.layout="button")},b.setupHooks=function(){var a=this;this.addHook("before-show-content",function(){a._stopTrackIFrameSizes()}),this.addHook("facebook-like-button-unlock",function(){a.unlock("button",a.name,a.url)})},b.requestState=function(b){var c="page_"+a.pandalocker.tools.hash(this.url)+"_hash_"+this.networkName+"-subscribe",d=this._getStateStorage();d.requestState(this._getStorageIdentity(),b),d.requestState(c,b)},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-facebook-like",function(c,d){b.url===a.pandalocker.tools.URL.normalize(d)&&b.unlock("button",b.name,b.url)})},b.removeConfirmation=function(){this.fbAlertConfirmation.hide(),this.button.parent().removeClass("onp-sl-fb-like-alert-confirmation-border"),this.button.parent().css({height:"auto",width:"auto"})},b.buttonReload=function(){this.holder&&(this.button.remove(),this.renderButton(this.holder))},b.renderButton=function(b){var c=this;if(this.holder=b,this.button=a("<div></div>").appendTo(this.holder),this.fbAlertConfirmation=a('<div class="onp-sl-fb-like-alert-confirmation-hint">'+this.options.tooltipText+"</div>"),this.button.closest(".onp-sl-control-inner-wrap").append(this.fbAlertConfirmation),this.button.attr("data-show-faces",!1),this.button.attr("data-send",!1),this.button.attr("data-href",this.url),this.options.font&&this.button.attr("data-font",this.options.font),this.options.colorScheme&&this.button.attr("data-colorscheme",this.options.colorScheme),this.options.ref&&this.button.attr("data-ref",this.options.ref),this.options.width&&this.button.attr("data-width",this.options.width),this.options.layout&&this.button.attr("data-layout",this.options.layout),this.options.verbToDisplay&&this.button.attr("data-action",this.options.verbToDisplay),this.button.addClass("fb-like"),window.FB.XFBML.parse(b[0]),c._startTrackIFrameSizes(),this.groupOptions.counters)var d=0,e=setInterval(function(){var a=c.button.find("iframe");if(a.length){var b=parseInt(c.button.parent().css("width"))?parseInt(c.button.parent().css("width")):c.button.parent().width(),f=parseInt(a[0].style.height)?parseInt(a[0].style.height):a.height(),g=parseInt(a[0].style.width)?parseInt(a[0].style.width):a.width();g&&200>g&&g>b&&c.button.add(c.button.parent()).width(g+2),d>10&&(c.button.data("default-height",f).data("default-width",g),clearInterval(e)),d++}},500)},b._startTrackIFrameSizes=function(){var b=this;this._trackIFrameTimer=null;var c=!1;this.button.hover(function(){a.pandalocker.data.__fbLikeButton=b;var d=b.control.find("iframe");if(d.length&&!b._trackIFrameTimer){var e=0;b._trackIFrameTimer=setInterval(function(){var f=parseInt(d[0].style.height)||d.height(),g=parseInt(d[0].style.width)||d.width(),h=14==f||34==f;h&&(b._stopTrackIFrameSizes(),b._trackIFrameTimer=null,b.fbAlertConfirmation.show(),b.button.parent().addClass("onp-sl-fb-like-alert-confirmation-border"),b.button.add(b.button.parent()).width(g).height(f),a.pandalocker.tools.isMobile()&&(navigator.userAgent.indexOf("FBMD/iPad")+1||navigator.userAgent.indexOf("FBSN/iPhone")+1)&&b.unlock("error")),e>=100&&c&&b._stopTrackIFrameSizes(),e++},10)}},function(){setTimeout(function(){b._stopTrackIFrameSizes(),b._trackIFrameTimer=null},2e3)})},b._stopTrackIFrameSizes=function(){this._trackIFrameTimer&&clearInterval(this._trackIFrameTimer)},a.pandalocker.controls["social-buttons"]["facebook-like"]=b}(__$onp);
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);b.name="facebook-share",b._defaults={url:null,layout:"button_count",count:"standard",lang:"en_US",width:null,shareDialog:!1,name:null,caption:null,description:null,image:null,unlock:null},b.prepareOptions=function(){return this.url=this._extractUrl(),this.options.appId&&"117100935120196"!=this.options.appId?void("vertical"===this.groupOptions.layout?this.options.layout="box_count":this.groupOptions.counters||(this.options.layout="button")):(this.showError(a.pandalocker.lang.errors.emptyFBAppIdError),!1)},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-facebook-share",function(c,d){b.url===a.pandalocker.tools.URL.normalize(d)&&b.unlock("button",b.name,b.url)})},b.renderButton=function(b){var c=this;this.button=a("<div></div>").appendTo(b),this.button.attr("data-href",this.url),this.options.width&&this.button.attr("data-width",this.options.width),this.options.layout&&(this.button.attr("data-layout",this.options.layout),this.button.attr("data-type",this.options.layout));var d=a("<div class='onp-sl-facebook-share-overlay'></div>").appendTo(b);if(this.groupOptions.counters)var e=0,f=setInterval(function(){var a=c.button.find("iframe");if(a.length){var b=parseInt(c.button.parent().css("width"))?parseInt(c.button.parent().css("width")):c.button.parent().width(),d=parseInt(a[0].style.width)?parseInt(a[0].style.width):a.width();200>d&&d>b&&c.button.add(c.button.parent()).width(d+2),e>10&&clearInterval(f),e++}},500);c.options.shareDialog?d.click(function(){return FB.ui({method:"share",href:c.url,display:"popup"},function(b){return console&&console.log&&console.log("AX12:"),console&&console.log&&console.log(b),a.pandalocker.tools.isTabletOrMobile()&&"undefined"==typeof b||null===b?void a(document).trigger("onp-sl-facebook-share",[c.url]):void("undefined"!=typeof b&&null!==b&&("object"==typeof b&&b.error_code&&b.error_code>0||a(document).trigger("onp-sl-facebook-share",[c.url])))}),!1}):d.click(function(){return FB.ui({method:"feed",name:c.options.name,link:c.url,picture:c.options.image,caption:c.options.caption,description:c.options.description},function(b){return console&&console.log&&console.log("AX12:"),console&&console.log&&console.log(b),a.pandalocker.tools.isTabletOrMobile()&&"undefined"==typeof b||null===b?void a(document).trigger("onp-sl-facebook-share",[c.url]):void("undefined"!=typeof b&&null!==b&&("object"==typeof b&&b.error_code&&b.error_code>0||a(document).trigger("onp-sl-facebook-share",[c.url])))}),!1}),this.button.addClass("fb-share-button"),window.FB.XFBML.parse(b[0])},a.pandalocker.controls["social-buttons"]["facebook-share"]=b}(__$onp);
...
!function(a){"use strict";a.pandalocker.mail_share||(a.pandalocker.mail_share={});var b=a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);b.name="mail-share",b.sdk="mail",b.buttonCounterBuffer=0,b.taskcheckShared=0,b.useButtonFrameId=null,b._defaults={pageUrl:null,pageTitle:null,pageDescription:null,pageImage:null,counter:!0,clickja:!0},b._extractUrl=function(){var b=this.options.pageUrl||this.networkOptions.url||window.location.href;if("cyrillic"==a.pandalocker.tools.cdmt(b)){var c=b.split("/");b=c[0]+"//"+punycode.toASCII(a.pandalocker.tools.ncdn(c[2]))}return a.pandalocker.tools.URL.normalize(b)},b.prepareOptions=function(){a.pandalocker.browser&&a.pandalocker.browser.YaBrowser&&(this.options.clickja=!1),this.url=this._extractUrl(),this.options.counter="vertical"===this.groupOptions.layout?!0:this.groupOptions.counters},b.verification={container:".onp-sl-button-loaded",timeout:5e3},b.setupEvents=function(){},b.showShareWindow=function(){var b=this,c=(b.options.pageTitle?"&title="+encodeURIComponent(b.options.pageTitle):"")+(b.options.pageDescription?"&description="+encodeURIComponent(b.options.pageDescription):"")+(b.options.pageImage?"&image_url="+b.options.pageImage:""),d=550,e=420,f=screen.width?screen.width/2-d/2+a.pandalocker.tools.findLeftWindowBoundry():0,g=screen.height?screen.height/2-e/2+a.pandalocker.tools.findTopWindowBoundry():0,h=window.open("//connect.mail.ru/share?url="+encodeURIComponent(b.url)+c,"Sociallocker","width="+d+",height="+e+",left="+f+",top="+g+",resizable=yes,scrollbars=yes,status=yes"),i=0,j=setInterval(function(){h&&h.closed===!1||(clearInterval(j),b.checkShared()),i++,1>=i&&b.locker._showScreen("data-processing")},200)},b.checkShared=function(b){var c=this;c.getShareCounterScripts(function(d){return c.buttonCounterBuffer<d?(c.unlock("button",c.name,c.url),c.taskcheckShared=0,c.buttonCounterBuffer=d,b&&b("success"),!1):void setTimeout(function(){if(c.taskcheckShared>3){c.taskcheckShared=0;var d={textMessage:a.pandalocker.lang.notUnlockPromptText,textButtonYes:a.pandalocker.lang.notUnlockPromptButtonYes,textButtonNo:a.pandalocker.lang.notUnlockPromptButtonNo};return b&&b("fail",d),c.locker._showScreen("prompt",{textMessage:a.pandalocker.lang.mailCanNotOpenLockerPromptText,textButtonNo:a.pandalocker.lang.mailCanNotOpenLockerPromptButtonNo}),!1}c.checkShared(),c.taskcheckShared++},1500)})},b.setButtonCounter=function(a){this.buttonCounter.text(this.minimalizeLargeNum(a)),this.options.counter&&this.buttonCounter.addClass("onp-sl-show"),this.button.addClass("onp-sl-button-loaded")},b.updateCounter=function(){var a=this;this.getShareCounterScripts(function(b){a.buttonCounterBuffer=b,a.setButtonCounter(b)})},b.getShareCounterScripts=function(b){var c=this;a.getJSON("//connect.mail.ru/share_count?url_list="+encodeURIComponent(c.url)+"&callback=1&func=?",function(d,e){var f="cyrillic"==a.pandalocker.tools.cdmt(c.url)?punycode.toASCII(a.pandalocker.tools.ncdn(c.url)):c.url,g=d&&d[f]&&d[f].shares||"0";b&&b(g)})},b.minimalizeLargeNum=function(a){return 1e3>a?a:(a/=1e3,a=Math.round(10*a)/10,a+"k")},b.renderButton=function(b){var c=this;c.button=a('<div class="onp-sl-flat-button-default onp-sl-mail-share-button"><div class="onp-sl-flat-button-left-side"><i class="onp-sl-mail-share-logo"></i></div><span>'+a.pandalocker.lang.socialButtons.vkShare+"</span></div>").appendTo(b),c.buttonCounter=a('<div class="onp-sl-flat-button-counter">-</div>'),c.button.after(c.buttonCounter),c.button.click(function(){c.updateCounter(),c.showShareWindow()}),c.updateCounter()},a.pandalocker.controls["social-buttons"]["mail-share"]=b}(__$onp);
!function(a){"use strict";a.pandalocker.vk_like||(a.pandalocker.vk_like={}),a.pandalocker.vk_like.lastHoverWidget=null;var b=a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);b.name="vk-like",b.sdk="vk",b.idx=0,b.hoverWidget=!1,b._defaults={type:"mini",pageTitle:null,pageDescription:null,pageUrl:null,pageImage:null,text:null,pageId:null,height:20,verb:0,requireSharing:1},b._extractUrl=function(){var b=this.options.pageUrl||this.networkOptions.url||window.location.href;if("cyrillic"==a.pandalocker.tools.cdmt(b)){var c=b.split("/");b=c[0]+"//"+punycode.toASCII(a.pandalocker.tools.ncdn(c[2]))}return a.pandalocker.tools.URL.normalize(b)},b.prepareOptions=function(){this.url=this._extractUrl(),"vertical"===this.groupOptions.layout&&(this.options.type="vertical"),this.options.counter="vertical"===this.groupOptions.layout?!0:this.groupOptions.counters},b.verification={container:".onp-sl-button-loaded",timeout:5e3},b.setupEvents=function(){var b=this;if(a(document).bind("vk-like",function(c,d){b.url===a.pandalocker.tools.URL.normalize(d)&&b.unlock("button",b.name,b.url)}),!b.options.appId)return b.showError(a.pandalocker.lang.errors.emptyVKAppIdError),!1;window.VK.init({apiId:b.options.appId,onlyWidgets:!0});var c="widgets.like.liked";window.VK.Observer.subscribe(c,function(c){a(document).trigger("vk-like",[b.url])})},b.showVkShareHint=function(){this.vkShareHintShown||(this.vkShareHintShown=!0,this.vkShareHint||(this.vkShareHint=a('<div class="onp-sl-vk-like-alert">'+a.pandalocker.lang.errors.vkLikeAlertText+"</div>").hide().prependTo(a("body"))),this.locateVkShareHint(),this.vkShareHint.show())},b.hideVkShareHint=function(){this.vkShareHintShown&&this.vkShareHint&&(this.vkShareHintShown=!1,this.vkShareHint.hide())},b.locateVkShareHint=function(){var b=this,c=b.button.find("iframe");if(c&&c.attr("id")){var d=c.attr("id").replace(/vkwidget/i,"");b.vkShareHintTarget&&b.vkShareHintTarget.length||(b.vkShareHintTarget=a("#vkwidget"+d+"_tt")),b.vkShareHint&&b.vkShareHint.css({top:parseInt(b.vkShareHintTarget.css("top"))+115,left:parseInt(b.vkShareHintTarget.css("left"))-120})}},b.runVkShareHintTimer=function(){var a=this;a.vkShareHintTimerTimout=2e4;var b=200;a.vkShareHintTimer||(a.vkShareHintTimer=setInterval(function(){return a.vkShareHintTimerTimout=a.vkShareHintTimerTimout-b,a.vkShareHintTimerTimout<=0?void a.stopVkShareHintTimer():void(a.vkShareHintTarget.is(":visible")?a.showVkShareHint():a.hideVkShareHint())},b))},b.stopVkShareHintTimer=function(){this.vkShareHintTimer&&(clearInterval(this.vkShareHintTimer),this.vkShareHintTimer=null,this.hideVkShareHint())},b.renderButton=function(b){var c=this;this.button=a("<div></div>").appendTo(b);var d=Math.floor(999999*Math.random()+1);if(c._widgetId="vk-like-"+d,c.options.appId){c.options.pageId?window.VK.Widgets.Like(c._widgetId,c.options,c.options.pageId):window.VK.Widgets.Like(c._widgetId,c.options),c.button.parent().mouseover(function(a){c.hoverWidget=!0}).mouseout(function(a){c.hoverWidget=!1}),c.button.attr("id",c._widgetId),c.options.counter||c.button.wrap('<div class="onp-sl-vk-like-counteroff"></div>'),b.closest(".onp-sl").hover(function(){a.pandalocker.vk_like.lastHoverWidget=c});var e=0,f=setInterval(function(){if(e++,e>150&&clearInterval(f),c.button.find("iframe").length){if("67d98c79"==a.pandalocker.tools.hash(c.button.css("background"))||a.pandalocker.tools.hash("4271673a"==c.button.css("background")))return void(e>100&&(c.showError(a.pandalocker.lang.errors.emptyVKAppInvalidBaseDomain),clearInterval(f)));c.button.addClass("onp-sl-button-loaded"),clearInterval(f)}},50)}},a.pandalocker.controls["social-buttons"]["vk-like"]=b}(__$onp);
...
!function(a){"use strict";a.onepress||(a.onepress={}),a.pandalocker.sdk||(a.pandalocker.sdk={}),a.pandalocker.sdk.mail=a.pandalocker.sdk.mail||{name:"mail",url:"//connect.mail.ru/js/loader.js",scriptId:"mail-jssdk",hasParams:!0,isRender:!0,timeout:1e4,isLoaded:function(){return window.mailru&&"object"==typeof window.mailru},prepare:function(){},createEvents:function(){var b=this,c=this.isLoaded(),d=function(){a(document).trigger(b.name+"-init")};return c?void d():void a(document).bind("mail-script-loaded",function(){d()})}}}(__$onp);
...
!function(a){"use strict";a.onepress||(a.onepress={}),a.pandalocker.sdk||(a.pandalocker.sdk={}),a.pandalocker.sdk.onp=a.pandalocker.sdk.onp||{name:"onp",url:"http://cdn.sociallocker.ru/service/ifbcreator.js",scriptId:"onp-jssdk",hasParams:!0,isRender:!0,timeout:1e4,isLoaded:function(){return window.ONPWGT&&"object"==typeof window.ONPWGT},prepare:function(){},createEvents:function(){var b=this,c=this.isLoaded(),d=function(){a(document).trigger(b.name+"-init")};if(c)return void d();if(window.onpwgt___asyncInit)var e=window.onpwgt___asyncInit;window.onpwgt___asyncInit=function(){d(),e&&e(),window.onpwgt___asyncInit=function(){}}}}}(__$onp);
